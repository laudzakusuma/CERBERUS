    ...
    async sendOnChainAlert(threat) {
        try {
            ...
            const params = [ 
                ...
                severity, // ThreatLevel _level
                0, // ThreatCategory _category (0 = UNKNOWN)
                Math.floor(aiAnalysis.confidence || 80), // uint256 _confidenceScore
                Math.floor(riskScore), // uint256 _severityScore
                aiAnalysis.threat_signature.substring(0, 100), // string _description
            ...
            if (error.message.includes('already reported')) {
                ...
                console.log('      -> ❌ PERMISSION DENIED: Run grant-role.js first');
            } else {
